...
<!--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous">-->
    <link href="<?= \App\Router::urlTo('css/bootstrap.min.css');?>" rel="stylesheet">
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= \App\Router::urlTo('/');?>">Home</a>
                        <!-- <a class="nav-link active" aria-current="page" href="#">Home</a> -->
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= \App\Router::urlTo('productos');?>">Productos</a>
                    </li>
                    <?php
                    if($auth->isAuthenticated()): ?>
                    <li class="nav-item">
                        <form action="<?= \App\Router::urlTo('cerrar-sesion');?>" method="post">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= \App\Router::urlTo('iniciar-sesion');?>">Iniciar Sesión</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= \App\Router::urlTo('registro');?>">Registrarse</a>
                    </li>
                    <?php
                    endif; ?>
                </ul>
